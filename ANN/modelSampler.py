...
class ModelSampler:
    ...
    def sampleModels(self, layerSkeleton, regularization=0.01, stepSize=0.01, 
        ...
        for layers in layerSkeleton:
            ...
            plotLearningCurve(accLC, f1LC, preLC, recLC, title="Model Learning Curve- Acc and F1")
            

        # Plot the metrics
        # print("acc",modelAccuracy, modelF1Score)
        # saveFileValuesCSV(fileName="ANN/{}_model_regularization_{}_stepSize_{}_batchSize_{}.csv".format(self.filePath.split('/')[1],regularization, stepSize, batchSize, stoppingCriterionCategory), F1=modelF1Score, Accuracy=modelAccuracy, Loss=modelDecEpoch, models=models)
